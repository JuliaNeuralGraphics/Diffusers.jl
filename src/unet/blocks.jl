...
function (cattn::CrossAttnDownBlock2D)(
    ...
    E <: Union{AbstractArray{Float32, 2}, AbstractArray{Float16, 2}},
...
function (block::DownBlock2D)(x::T, temb::E) where {
    T <: Union{AbstractArray{Float32, 4}, AbstractArray{Float16, 4}}, E <: Union{AbstractArray{Float32, 2}, AbstractArray{Float16, 2}},
}
...
function (block::SamplerBlock2D)(x::T) where T <: Union{AbstractArray{Float32, 4}, AbstractArray{Float16, 4}}
...
function (mb::MidBlock2D{R, A})(
    ...
    R, A,
    T <: Union{AbstractArray{Float32, 4}, AbstractArray{Float16, 4}},
    E <: Union{AbstractArray{Float16}, AbstractMatrix{Float32}},
}
